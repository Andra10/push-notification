...
<template lang="pug">
micro-stack.push-notification( ref="microStack" )
    <!--bell microinteraction-->
    
    micro-stage( @leave="leaveStageOne" @click="$refs.microStack.nextStage()" ) 
        .badge( ref="badge" ): span 1
        .bell( ref="bell" ): BellIcon

        <!--onclick opens module-->

    micro-stage.push-notification__notifications-stack( @enter="enterStageTwo" @leave="leaveStageTwo" )
        .notification( ref="notification" @click="$refs.microStack.nextStage()" )
            .author
                ...
                div
                    ...
                    .notification__details updated status 09/12/2022, 19:00
        ...
        .message__header
            .author
                ...
                div
                    .author__name John Doe
                    .notification__details updated status 09/12/2022, 19:00
            .push-notification__close-button( @click="close" ): CloseIcon
    
        .message__content( ref="content" )
            p.
                I wanted to let you know that I have uploaded a new document for you to read.
                Please take a moment to review it and let me know if you have any questions or comments.
            .asset( :class='[ `asset--doc-type` ]' )
                .asset__icon: DocIcon
                .asset__details
                    .asset__name new-document.doc
                    .asset__size 6.49MB
        .message__footer
            .seen
                span Seen
